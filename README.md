...
3. Open a File Explorer, Navigate to "C:\Rainmeter" & Delete the "Skins" Folder & the "Rainmeter.ini" file
...
8. Test the hotkeys to launch the different panels (Black, Gray & White like the Demo Above)
