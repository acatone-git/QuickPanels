...
7. Run RestartRainmeter.exe to complete the Rainmeter \ Quantum Dock Setup
8. Now open the Huion \ XP-Pen \ Wacom App & Set the buttons to QD1 \ QD2 \ QD3 in C:\Rainmeter\Launchers
9. Test the buttons to launch the different docks (Black, Gray & White)
