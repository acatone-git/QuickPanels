...
- If the panels don't show up, please make sure that Rainmeter is running in the system tray area, if not, launch it again using the icon on the desktop / Rainmeter.exe in "C:\Rainmeter"
- To enable Rainmeter at system launch, please follow this video: https://www.youtube.com/watch?v=oZxTLdSEP70
