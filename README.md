...
1. Install [Rainmeter](https://github.com/rainmeter/rainmeter/releases) in portable mode to "C:\Rainmeter" & Select "Run Rainmeter" at the end of the installation process 
...
4. Download & Extract the [QuickPanels Archive](https://github.com/acatone-git/QuickPanels/releases) to "C:\Rainmeter" (The folders Skins & Launchers should appear next to the other folders and executables)
